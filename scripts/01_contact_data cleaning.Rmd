...
contact_hh_all = contact_hh_all %>% 
  dplyr::mutate(age_group_contact = case_when(hh_member_age == 0 ~ "< 6 months",
                                               hh_member_age == 1 ~ "6-11 months",
                                               hh_member_age == 2 ~ "1-4 yrs",
                                               hh_member_age == 3 ~ "5-9 yrs",
                                               hh_member_age == 4 ~ "10-19 yrs",
                                               hh_member_age == 5 ~ "20-29 yrs",
                                               hh_member_age == 6 ~ "30-39 yrs",
                                               hh_member_age == 7 ~ "40-49 yrs",
                                               hh_member_age == 8 ~ "50-59 yrs",
                                               hh_member_age == 9 ~ "60+ yrs",
                                               hh_member_age == 10 ~ "I don't know",
                                               hh_member_age == 0 ~ "6-11 months",
                                               hh_member_age %in% 1:4 ~ "1-4 yrs",
                                               hh_member_age %in% 5:9 ~ "5-9 yrs",
                                               hh_member_age %in% 10:19 ~ "10-19 yrs",
                                               hh_member_age %in% 20:29 ~ "20-29 yrs",
                                               hh_member_age %in% 30:39 ~ "30-39 yrs",
                                               hh_member_age %in% 40:49 ~ "40-49 yrs",
                                               hh_member_age %in% 50:59 ~ "50-59 yrs",
                                               hh_member_age >=60 ~ "60+ yrs"))
contact_hh_all$age_group_contact = factor(contact_hh_all$age_group_contact, 
                   levels = c("< 6 months", "6-11 months", "1-4 yrs", "5-9 yrs", 
                              "10-19 yrs", "20-29 yrs", "30-39 yrs", 
                              "40-49 yrs", "50-59 yrs", "60+ yrs", "I don't know"))
...
ind$age_cat <- NA
ind <- ind %>% dplyr::mutate(age_cat = case_when(group == 1 ~ "< 6 months", 
                                          group == 2 ~ "6 - 11 months", 
                                          group == 3 ~ "1 - 4y", 
                                          group == 4 ~ "5 - 9y", 
                                          group == 5 ~ "10 - 14y", 
...
ind$age_cat <- factor(ind$age_cat, 
                   levels = c("< 6 months", "6 - 11 months", "1 - 4y", "5 - 9y", 
