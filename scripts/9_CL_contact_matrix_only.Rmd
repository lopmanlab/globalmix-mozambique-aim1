...
m_u1 <- contact_matrix(df_u, 
                      age.limits = c(0,18,60,99), ##Specify age bands for the matrix
...
#Code to take the mean of matrices
Reduce("+", lapply(m_u2$matrices, function(x) {x$matrix})) / length(m_u2$matrices)
...
#Code to take the mean of matrices
Reduce("+", lapply(m_u3$matrices, function(x) {x$matrix})) / length(m_u2$matrices)
...
#Code to take the mean of matrices
Reduce("+", lapply(m_u4$matrices, function(x) {x$matrix})) / length(m_u4$matrices)
