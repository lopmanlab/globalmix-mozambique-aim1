...
drop_recid <- c("405", "443", "445", "1815", "1827", "1828", "6843")
...
data <- data %>%
  ...
  mutate(hh_id = case_when(rec_id == "716" ~ "0501-031",
                           rec_id == "756" ~ "3204-399",
                           rec_id == "844" ~ "3305-289",
                           rec_id == "935" ~ "3102-218",
                           rec_id == "989" ~ "3208-386",
...
rm(drop_recid, drop_recid2, drop_hhs)
```
...
hmid <- data %>%
  ...
  arrange(individual_id, hh_id, rec_id) 
...
hmid <- rbind(hmid, urbhhid) %>%
  select(rec_id, study_site, hh_id2) %>%
  rename(hh_id = hh_id2)
...
participant_vars <- c("rec_id", "study_site", "aim", "isindex", "sensor_id",
...
contact_hh_all = contact_hh_all %>% 
  dplyr::mutate(hh_member_relationship = case_when(hh_member_relationship == 0 ~ "Spouse",
                                                   ...
                                                   hh_member_relationship == 9 ~ "Non-relative",
...
contact_nonhh_all$hh_member_relationship <- "Non-relative"
```
...
contact_vars <- c("rec_id", "study_site", "survey_date", "survey_date_2", "study_day", "age_group_contact", 
               "contact_sex","touch_contact", "fromdayone", "share_room", "share_bed", 
               "cook_food", "where_contact","contact_mask", "duration_contact", "frequency_contact",
               "known_contact", "hh_member_relationship", "hh_membership", "relationship",
               "location_contact___0","location_contact___1","location_contact___2",
               "location_contact___3", "location_contact___4", "location_contact___5",
               "location_contact___6", "location_contact___7","location_contact___8",
               "location_contact___9", "location_contact___10", "location_contact___11")
...
saveRDS(participants_aim2, "/Users/mkiti/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/Aim-2/sites/joint_analysis/data/diary/participant_data_aim2.RDS")

saveRDS(contacts_aim2, "/Users/mkiti/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/Aim-2/sites/joint_analysis/data/diary/contact_data_aim2.RDS")
```
...
saveRDS(hh_survey_aim2, "/Users/mkiti/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/Aim-2/sites/joint_analysis/data/diary/household_survey_aim2.RDS")
...
loc_visit_aim2 <- loc_visit %>%
  filter(rec_id %in% participants_aim2$rec_id)
saveRDS(loc_visit_aim2, "/Users/mkiti/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/Aim-2/sites/joint_analysis/data/diary/locations_visited_aim2.RDS")
...
exit_interview_aim2 <- exit %>%
  filter(rec_id %in% participants_aim2$rec_id)
saveRDS(exit_interview_aim2, "/Users/mkiti/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/Aim-2/sites/joint_analysis/data/diary/exit_interview_aim2.RDS")
