...
participant <- participant %>%
  dplyr::mutate(occupation = case_when(occupation___0 == 1 ~ "Unemployed",
                ...
                occupation = case_when(participant_age == "<6mo" ~ "Child",
                                       ...
                                       # additional cleaning
                                       (is.na(occupation) & participant_age == "1-4y") ~ "Child",
                                       (occupation == "Unemployed" & participant_age == "1-4y") ~ "Child",
                                       (is.na(occupation) & participant_age == "5-9y") ~ "Student",
                                       occupation == "Fisherman" ~ "Other", 
                                       TRUE ~ occupation))
participant$occupation <- factor(participant$occupation, 
                                 levels = c("Child", "Unemployed", "Student", 
                                            "Homemaker", "Casual laboror", 
                                            "Farmer", "Businessperson", 
                                            "Office worker", "Retired",
                                            "Other"),
                                 labels = c("Child", "Unemployed", "Student", 
                                            "Homemaker", "Casual laboror", 
                                            "Farmer", "Businessperson", 
                                            "Office worker", "Retired",
                                            "Other"))
...
saveRDS(participants_aim2, "/Users/mck/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/aim_2/analysis/diary/data/participant_data_aim2.RDS")

saveRDS(contacts_aim2, "/Users/mck/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/aim_2/analysis/diary/contact_data_aim2.RDS")
```
...
hh_survey <- hh_survey %>% 
  dplyr::mutate(study_site = case_when(study_site == 1 ~ "Manhiça",
                                       study_site == 2 ~ "Polana Caniço"),
                study_site = factor(study_site, levels = c("Manhiça", "Polana Caniço"),
                                    labels = c("Rural", "Urban")),
                ...
                hh_head_gender = case_when(hh_head_gender == 0 ~ 'Female',
                                           ...
                                           TRUE ~ "Other"),
                hh_head_gender = factor(hh_head_gender, 
                                        levels = c("Female", "Male")),
                ...
                hh_roof_material = factor(hh_roof_material, 
                                          levels = c("Rudimentary", "Natural", "Modern", "Other")),
                ...
                hh_wall_material = factor(hh_wall_material, 
                                          levels = c("Rudimentary", "Natural", "Modern", "Other")),
...
hh_survey <- hh_survey %>% 
  ...
  dplyr::mutate(wash_hands_defecate = case_when(wash_hands_defecate == 0 ~ "Never",
                ...
                wash_hands_defecate = factor(wash_hands_defecate, 
                ...
                wash_hands_food =  factor(wash_hands_food, levels = c("Never", "Rarely", "Sometimes", "Always")),
                ...
                wash_hands_toilet = factor(wash_hands_toilet, 
...
hh_survey = hh_survey %>% 
  ...
  dplyr::mutate(hh_smoking = case_when(hh_smoking == 0 ~ "No",
                ...
                hh_cook = case_when(hh_cook == 0 ~ "Inside",
                                    hh_cook == 1 ~ "Outside",
                                    hh_cook == 2 ~ "Both"),
                hh_cook = factor(hh_cook, 
                                 levels = c("Inside", "Outside", "Both")))
...
saveRDS(hh_survey_aim2, "/Users/mck/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/aim_2/analysis/diary/household_survey_aim2.RDS")
...
saveRDS(loc_visit_aim2, "/Users/mck/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/aim_2/analysis/diary/locations_visited_aim2.RDS")
...
saveRDS(exit_interview_aim2, "/Users/mck/Library/CloudStorage/OneDrive-EmoryUniversity/4.Data and Analysis/GlobalMix/Mozambique/Quantitative/aim_2/analysis/diary/exit_interview_aim2.RDS")
