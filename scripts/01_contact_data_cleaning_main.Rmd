...
participants_aim1b <- rbind(participants_aim1, participants_aim2_index) %>%
...
saveRDS(participants_aim1b, "../data/clean/participant_data_aim1b.RDS")
saveRDS(contacts_aim1, "../data/clean/contact_data_aim1b.RDS")
...
saveRDS(participants_aim2, "../data/clean/participant_data_aim2b.RDS")
saveRDS(contacts_aim2b, "../data/clean/contact_data_aim2b.RDS")
...
hh_survey_aim1 <- hh_survey %>%
  filter(rec_id %in% participants_aim1b$rec_id) %>%
  select(-c(hoh_id))

saveRDS(hh_survey_aim1, "../data/clean/household_survey_aim1b.RDS")
...
saveRDS(hh_survey_aim2, "../data/clean/household_survey_aim2b.RDS")
