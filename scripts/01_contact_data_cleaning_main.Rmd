...
EXPORT_PATH <- "/Users/mck/Library/CloudStorage/OneDrive-EmoryUniversity/3.GlobalMix/Globalmix country data/Mozambique/aim_2"

saveRDS(participants_aim2, paste0(EXPORT_PATH, "/ind_participant_data_aim2.RDS"))
saveRDS(contacts_aim2, paste0(EXPORT_PATH, "/ind_contact_data_aim2.RDS"))
saveRDS(hh_survey_aim2, paste0(EXPORT_PATH, "/ind_household_survey_data_aim2.RDS"))
saveRDS(loc_visit_aim2, paste0(EXPORT_PATH, "/ind_locations_visited_data_aim2.RDS"))
saveRDS(exit_interview_aim2, paste0(EXPORT_PATH, "/ind_exit_interview_data_aim2.RDS"))
```