...
cont_d1_hh <- cont_d1_hh %>%
  ...
  select("rec_id", "redcap_event_name", "redcap_repeat_instrument",
         ...
         "contact_id", "hh_member_id2", "hh_member_name") # drop hh_member_name,  "hh_member_id", 
# "individual_id",
```
...
cont_d2_hh <- cont_d2_hh %>%
  ...
  select("rec_id", "redcap_event_name", "redcap_repeat_instrument",
         ...
         "contact_id","hh_member_id2", "hh_member_name") # drop   "hh_member_id", 
# "individual_id",
```
