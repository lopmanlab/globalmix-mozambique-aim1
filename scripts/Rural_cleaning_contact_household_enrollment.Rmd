...
contact_hh_all <- contact_hh_all %>% left_join(hh_member, by=c("rec_id","hh_member_name"))

contact_hh_repeat <- contact_hh_all %>%
  group_by(rec_id, hh_member_name) %>%
...
contact_hh_all <- contact_hh_all %>%
  left_join(contact_hh_repeat, by=c("rec_id","hh_member_name")) %>%
