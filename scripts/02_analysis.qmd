...
```{r}
#| label: fig-participant-summary
#| tbl-cap: "Participant summary"
#| include: true
#| warning: false

source("../scripts/baseline_plot_functions.R")
# =======================
# function to plot by age
# CURRENTLY DOES NOT WORK
# fun_baseline_plot <- function(data){
#   data %>%
#     ggplot(aes(x = total, y = participant_age, fill = participant_sex)) +
...
ggsave(sex_page_plt, filename = "../output/figs/1a.participant age.pdf",
...
# library(ggpubr)
# ggarrange(sex_page_plt, literacy_page_plt, enrolledsch_page_plt, 
...
fig1_hist_d1 <- subplot(hist_rural_d1, hist_urban_d1, nrows=2, shareX = TRUE)
...
subplot(style(fig3_sex_rural_box, showlegend = F), nrows=2, fig3_sex_urban_box, 
