...
The figures below presents a summary the characteristics of the participants in the rural and urban site. A total of `r nrow(participants)` individuals participated in the study, with `r N_rural` and `r N_urban` participants recruited from the rural and urban sites, respectively. In some age groups (\<5 yrs and 40-59 yrs) we recruited more than the target. By site, there was no major difference in number of participants recruited by age, sex, and school enrollment status.
...
ggsave(sex_page_plt, filename = "../output/figs/1a_participant_age.pdf",
...
#| fig-cap: "Participant age and sex distribution by site"
#| include: true
#| warning: false
...
1. mean number of contacts over both days 
2. mean number of contacts of unique contacts only over both days 
3. mean number of unique contacts reported on both day 1 and 2
