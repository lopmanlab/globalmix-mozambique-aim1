...
trial_matrix <- levelplot(average_contact ~ participant_age*contact_age, 
                          data=m1_rural, 
                          xlab="Participant age", ylab="Contact age",
                          # col.regions = heat.colors(100),
                          main="")

symmetric_matrix_plot <- levelplot(average_contact ~ participant_age*contact_age, 
          data=symmetric_trial_matrix2, 
          xlab="Participant age", ylab="Contact age",
          # col.regions = heat.colors(100),
          main="")
symmetric_matrix_plot
trial_matrix / symmetric_matrix_plot
```

```{r}
fun_matrix1_plot(m1_rural, "Rural", xlab = "Participant age", ylab = "Contact age") 
