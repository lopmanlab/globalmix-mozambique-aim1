...
# Load packages
pacman::p_load(dplyr, ggplot2, gtsummary, Hmisc, knitr, kableExtra, lubridate, patchwork, 
              stringr,table1, tidyr, openxlsx)
...
contacts_aim1 <- contacts_aim1 %>%
  select(rec_id, survey_date, contact_sex, contact_age, touch_contact, where_contact,
         contact_mask, duration_contact, frequency_contact, known_contact, loc_home,
         loc_otherhome, loc_school, loc_work, loc_transport, loc_market, loc_street,
         loc_well, loc_agricfield, loc_playground, loc_worship, loc_other, 
         hh_membership, hh_member_relationship, repeat_contact_d2, fromdayone, 
         day_of_week, weekday, weeknum, year, weekyear)
# Day1or2 missing
