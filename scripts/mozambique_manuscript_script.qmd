...
combined_matrix3 <- subplot(style(rural_matrix_touch, showlegend = F), 
                            urban_matrix_touch, shareY = TRUE)  %>% 
  layout(annotations = list(  # Add x-axis title annotation
           list(
             x = 0.5,
