...
#   dplyr::filter(study_site == "Rural")
# 
# hist_rural <- ggplot(hist_rural, aes(x=num_contacts, fill="Rural")) +
#   geom_histogram(color="#a6611a", alpha=0.7, binwidth = 1) +
#   scale_fill_manual(values="#a6611a") +
#   geom_vline(xintercept=mean_contacts_site$mean[1], color="black") +
#   annotate("text", x=mean_contacts_site$mean[1]+1, y=60,
...
#   dplyr::filter(study_site == "Urban")
# 
# hist_urban <- ggplot(hist_urban, aes(x=num_contacts, fill="Urban")) +
#   geom_histogram(color="#018571", alpha=0.7, binwidth=1) +
#   scale_fill_manual(values="#018571") +
#   geom_vline(xintercept=mean_contacts_site$mean[2], color="black") +
#   annotate("text", x=mean_contacts_site$mean[2]+1, y=60,
#            label=paste0(mean_contacts_site$mean[2],
#                         " (95% CI ", ci_contacts_urban$`2.5 %`,"-",
#                         ci_contacts_urban$`97.5 %`,")"),
#            hjust=0, size=4) +
#   labs(x="Num of contacts",
#        y="Count") +
#   theme_minimal() +
#   theme(plot.title = element_text(size = 14),
#         axis.title.x = element_text(size=12, face="bold"),
...
# 
# # combine plots
# ggpubr::ggarrange(hist_rural, hist_urban, ncol = 1, nrow = 2,
#                   common.legend = FALSE, legend = "right",
#                   common.axis = TRUE, axis="tb",
