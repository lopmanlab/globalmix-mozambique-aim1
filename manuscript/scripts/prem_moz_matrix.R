...
age_cat_part <- data.frame(part_age1=c("0_4","5_9","10_14","15_19","20_24","25_29","30_34","35_39",
                           ...
                           part_age2 =c("0_9", "0_9", "10_19","10_19", "20_29", "20_29", "30_39", "30_39", 
                                        "40_49","40_49", "50_59", "50_59",  "60", "60", "60", "60"))
...
age_cat_cont <- data.frame(cont_age1 = colnames(moz_prem),
                           cont_age2 = c("0_9", "0_9", "10_19","10_19", "20_29", "20_29", "30_39", "30_39", 
                                         "40_49","40_49", "50_59", "50_59",  "60", "60", "60", "60"))
...
moz_pop_10yr <- read.csv("C:/Users/skim689/OneDrive - Emory University/Desktop/Mixing Studies/Global Mix/Mozambique/Contact Patterns Abstract/Pop Sizes/agecat_10_total.csv")
...
moz_prem10<- moz_prem %>%
  ...
  mutate(avg_cont_new = tot_pop_contacts/pop10yr)        ## average contacts made using 10-year age band

### plot
ggplot(moz_prem10, aes(x = part_age2, y = cont_age2, fill = avg_cont_new)) + theme(legend.position = "bottom") + 
  ...
  geom_tile()+
  geom_text(aes(label=round(avg_cont_new, digits=2)), colour = "black", check_overlap = TRUE)+
  theme()
